...
public class EmployeeController {
  ...
  @FXML private TextArea textarea_employee;

  @FXML private Button btn_createEmp;
  ...
  /**
   * This method is used when the create employee button is pressed. When the button is pushed, the
   * employees information is used to generate a username and email address. The password is also
   * checked to make sure it is strong enough.
   *
   * @param event
   */
  @FXML
  void createEmployee(MouseEvent event) {
    ...
    Label oops =
        new Label("Oops! Your password needs an uppercase, lowercase and a special character!");
    ...
    // Create a string that holds the employee's password after it goes through the Employee
    // methods.
