...
//This constructor for the ProductionRecord call that takes two arguments.
  public ProductionRecord(Product productProduced, int i) {
    ...
    serialNumber = productProduced.getManufacturer().substring(0,3)
        + productProduced.getType().code +"0000" + i;
  ...
  //This method cast the data into a string.
  public String toString(){
    return "\nProd. Num: " + this.productionNumber +","+
